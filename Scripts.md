...
We recommend leaving the `auto_uninstall` flag set to true, so that your App will properly remove scripts when uninstalled. More information about this flag can be found <a href="#script_object-properties">here</a>.
